...
{
	double fx;
    // sin(x) fonksiyonu derece parametresi alir ve hesaplanmýs halini gönderir
    //pow(x, y) x^y 'yi hesaplar ve degerini gonderir
    //sqrt(x) x'in karekokunu alir ve gonderir
    //log(
